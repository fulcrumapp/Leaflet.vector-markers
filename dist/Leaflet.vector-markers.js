  ...
  (function(window, document, undefined_) {
    ...
    L.VectorMarkers.Icon = L.Icon.extend({
      ...
      createIcon: function(oldIcon) {
        ...
        div.innerHTML = '<svg width="22.56px" height="32.729px" viewBox="0 0 22.56 32.729" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">' + '<path d="' + pin_path + '" fill="' + options.markerColor + '"></path>' + '<path fill="' + options.markerOutlineColor + '" d="' + pin_outline_path + '"/>' + icon + '</svg>';
